defmodule TheoryCraft.MarketSource.Processors.IndicatorProcessorTest do
  ...
  describe "next/2" do
    test "calls indicator module next with event and state" do
      ...
      assert %IndicatorValue{value: 0, data_name: "bar"} =
