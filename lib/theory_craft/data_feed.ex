defmodule TheoryCraft.DataFeed do
  ...
  To create a custom data feed, use the `TheoryCraft.DataFeed` module and implement
  ...
  A default implementation is provided when you `use TheoryCraft.DataFeed`, but it
