defmodule TheoryCraft.MarketSource.Indicator do
  @moduledoc """
  ...
  - **Indicators** (`TheoryCraft.MarketSource.Indicator`): Specialized for technical analysis calculations
  ...
  To create a custom indicator, implement the `TheoryCraft.MarketSource.Indicator` behaviour:
